export default {
  ...
  allShown: 'All messages shown ({count} rounds)',
  ...
  stopResume: 'Stop',
  resumeHint: 'Or just type a new question below (this is treated as "Stop" and answers with current results)',
  you: 'You',
  ...
  queued: 'Queued, {count} people ahead',
  thinking: 'Thinking…',
  retrieval: 'Retrieval',
