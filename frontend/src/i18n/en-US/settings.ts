export default {
  ...
  embeddingModelMgmt: {
    ...
    reindexBtn: 'Re-index All',
    reindexHint: 'Clears existing vector indexes first, then switches to the selected model and re-embeds all completed documents to rebuild the KB indexes.',
